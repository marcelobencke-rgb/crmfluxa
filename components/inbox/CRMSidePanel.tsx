...
export function CRMSidePanel({ conversation }: Props) {
  ...
  if (!conversation) {
    return (
      <aside className="flex flex-1 min-h-0 items-center justify-center border-l border-border p-4 text-center text-xs text-muted-foreground">
  ...
  return (
    <aside className="flex flex-1 min-h-0 flex-col gap-4 overflow-y-auto border-l border-border bg-background p-4">
      <section>
