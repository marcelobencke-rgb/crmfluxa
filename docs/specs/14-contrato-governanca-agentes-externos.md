...
> Fluxa CRM via MCP: quais tools existem, o input/output exato de cada uma, a
...
O Fluxa CRM expõe um **servidor MCP org-scoped**. O agente externo se autentica
...
> Fluxa CRM**; o lado do Vendaval é o FG-01.
