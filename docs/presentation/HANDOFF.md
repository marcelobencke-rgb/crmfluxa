...
- ✅ **Repositório no GitHub**: https://github.com/marcelobencke-rgb/crmfluxa
...
| **GitHub repo** | https://github.com/marcelobencke-rgb/crmfluxa (private) |
...
- **Memórias persistentes do projeto** em `~/.claude/projects/-Users-rafaelmelgaco-crmfluxa/memory/`
  ...
  - `project_naming_and_timeline.md` — Fluxa CRM, MVP-B 8-12 semanas
...
- Pitch deck pode ser renderizado com:
  ...
  ```
- GitHub repo: https://github.com/marcelobencke-rgb/crmfluxa (mostre as docs)
- Supabase Studio: dashboard.supabase.com → projeto Fluxa CRM → Database → Tables (31 tabelas com RLS verde)
