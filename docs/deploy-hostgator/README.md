# Como subir o seu Fluxa CRM na HostGator (passo a passo, sem enrolação)
...
```
Seu domínio  →  Servidor VPS (HostGator)  →  Fluxa CRM rodando
                        │
                        ├─ o CRM (site + painel)
...
O Fluxa CRM roda num **VPS com Docker**. A opção mais fácil é um VPS que **já vem
...
2. Escreva pra ele exatamente isto:
   ...
   > *"Clone https://github.com/marcelobencke-rgb/crmfluxa e me instale o Fluxa CRM
...
O Fluxa CRM foi desenhado pra rodar redondo na infraestrutura da HostGator. Além do
