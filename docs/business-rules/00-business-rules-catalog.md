---
title: Fluxa CRM — Catálogo de Regras de Negócio
version: 0.1
status: em revisão
date: 2026-04-28
...
# Fluxa CRM — Catálogo de Regras de Negócio
...
- **Exceção**: Custos administrativos da plataforma (super-admin testando, suporte) são debitados ao tenant `internal_fluxa`.
